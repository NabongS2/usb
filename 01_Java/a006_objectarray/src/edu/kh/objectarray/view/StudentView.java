...
public class StudentView {
	...
	private void selectAll() {
		...
		// Service 가 참조하는 객체의 필드 중 studentArr를 반환 받아
		// 각 배열 요소를 화면에 출력
	...
	private void selectIndex() {
		...
		// 반환 받은 index 번째 요소가 null이 아닐 경우(학생 정보가 있을 경우)
		// -> NullpointerException 방지처리
	...
	private void updateStudent() {
		...
		// 입력 받은 index 번째 학생의 점수를 수정하는 서비스를 호출
