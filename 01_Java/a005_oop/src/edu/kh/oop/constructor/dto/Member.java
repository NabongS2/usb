...
public class Member {
	...
	// 인스턴스 초기화 블럭 : 인스턴스 변수를 초기화 하는 블럭
	{
		...
		memberName = "고길동";
		memberAge = 40;
	} // mem2를 새로 만들면 똑같은 초기화 값으로 생성 된다.
	...
	// 프로그램이 열리면 static부터 찾음 위에다가 넣으면 계속 mem 생길 때 마다 초기화 시킴
	...
	public Member(String memberId) {
		...
		this.memberId = memberId; // 위에 필드에서 받아온 this를 String 멤버아이디에 넣겠다!
