...
public class MethodExView {
	...
	public void menu3() {
		...
		int[] numbers = service.fiveRandomNumbers(); // 1) 호출
		
		// 1) service의 fiveRandomNumbers();를 호출
		// 2) 난수 5개가 저장된 int[] 이 반환 됨 (돌아옴)
		//  -> 반환된 int[]은 실제 배열이 아닌
		//     int[]의 주소 값이다. (얕은 복사 참조의 개념)
	...
	private void menu4() {
		...
		// service의 calculate() 메서드 호출시 매개변수 3개를 전달
