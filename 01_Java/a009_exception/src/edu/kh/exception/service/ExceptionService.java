...
public class ExceptionService {
	public void ex1() throws IOException {
					// 해당 메서드 내에서 IOException이 발생 할 것을 대비한 예외처리 코드
		
		// 예외(Exception) 확인 하기
		
		// 키보드 입력을 효율적으로 읽어오는 객체
		// Scanner 보다 기능은 부족하지만 속도는 빠름
		...
		//    해당 코드 사용 시 문제가 발생 할 것이다 라고 생각하고
...
//		
	...
	public void ex2() {
		...
		try {
			...
			// catch의 매개 변수에는
			// 던져진 예외 객체를 저장 할 수 있는 참조 변수를 작성
	...
	public void ex3() {
		...
		try {
			...
			// 스캐너 사용시 작성 법이 잘못 되거나 범위를 초과하면 발생하는 예외
...
//		}
	...
	public void ex4() {
		...
		// throws : 해당 메서드에서 발생한 예외를 호출한 메서드로 던지는 예외 처리 방법
...
//			e.getMessage();
	...
	public void methodB() throws IOException{
		...
		methodC();
		// methodC() IOException을 던질 수도 있기 때문에
		// 호출 시 예외 처리 구문을 작성해야한다.
	}
