...
public class TestService {
	...
	public void ex1() {
		...
		p1.breath(); // void edu.kh.polymorphism.ex2.dto.Person.breath() -> 코와 입으로 숨을 쉰다.
		
		// 3. 추상 클래스는 객체 생성 X / 부모 타입 참조 변수 O
		// (다형성의 업캐스팅)
		Animal a1 = new Person("포유류","채식","김건강",30);
		a1.breath(); // void edu.kh.polymorphism.ex2.dto.Animal.breath() -> 코와 입으로 숨을 쉰다.
	...
	public void ex2() {
		...
		// - 인터페이스에 작성했지만 클래스에 작성하는 static 필드
	...
	public void ex3() {
		// 계산기 구현
		Calculator cal = new LNHCalculator();
