...
-- SEQUENCES 생성 (MEMBER, BOARD, COMMENT)
...
; --> 성공 1, 실패 0
-- (BOARD_NO, BOARD_TITLE, BOARD_CONTENT, CREATE_DT, READ_COUNT, DELETE_FL, MEMBER_NO)
...
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '실험용 댓글내용', DEFAULT , DEFAULT ,
		4, 2)
;


-- 댓글 등록 (번호 / 내용 / 회원번호 / 게시글 번호)
INSERT INTO "COMMENT"
