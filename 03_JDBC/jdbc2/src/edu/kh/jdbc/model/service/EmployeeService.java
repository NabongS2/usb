...
public class EmployeeService {
	...
	// doa에 여러 SQL을 수행하기 위한 메서드를 각각 작성하여 호출
	...
	public List<Employee> selectAll() throws SQLException{
		...
		// Connection 객체가 Service에 존재 해야 함
		// --> 만약 DAO에서 Connection 을 만들고 반환하면
		// 	   Service 쪽에서 Connection 을 사용할 수 없게 된다.
		...
		// ** DML 구분인 경우 해당 위치에 commmit / rollback 구문 작성 **
	 ...
	 * @return empList
	 */
	public List<Employee> salarySearch(int min, int max) throws SQLException{
		
		Connection conn = getConnection();
		
		List<Employee> empList = dao.salarySearch(conn,min,max);
