...
public class BoradView {
	...
	private void insertBoard() {
		...
		try {
			// 게시글 삽입 서비스 호출
			int result = boardService.insertBoard(title,content.toString(),Session.loginMember.getMemberNO());
