...
SELECT BOARD_NO , BOARD_TITLE , BOARD_CONTENT , MEMBER_NICKNAME,
	READ_COUNT , MEMBER_NO , PROFILE_IMG,
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/rabbitGun.jpg'
WHERE MEMBER_NO =4;

PROFILE_IMG = '/resources/images/member/hamster.jpg'
WHERE MEMBER_NO =1;
...
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 1513, 4, NULL)
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 1513, 4, NULL)
;

-- 1001, 1002
INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 1513, 4, 1010)
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 1513, 4, 1010)
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 1513, 4, 1010)
;

INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 1513, 4, 1011)
;
INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 1513, 4, 1011)
;
INSERT INTO "COMMENT"									-- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1-1', DEFAULT, DEFAULT, 1513, 4, 1015)
;
