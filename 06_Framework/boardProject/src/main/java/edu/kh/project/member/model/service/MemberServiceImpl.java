...
@Service // Service Layer
		 // 비지니스 로직(데이터 가공, DAO 호출, 트랜잭션 제어) 처리하는 클래스라 명시
		 // +Bean 등록하는 어노테이션
public class MemberServiceImpl implements MemberService{

	// org.slf4j.Logger : 로그를 작성 할 수 있는 객체
...
//		System.out.println("암호화 확인 : "+bcrypt.encode(inputMember.getMemberPw()));
	...
	// 예외가 발생하면 rollback 발생 안하면 서비스 종료 시 commit
	...
	public int signUp(Member inputMember) {
		...
		// 비밀번호를 BCypt를 이용하여 암호화 후 다시 inputMember에 세팅
