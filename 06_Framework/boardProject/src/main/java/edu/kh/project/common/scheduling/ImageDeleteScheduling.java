...
//	@Scheduled(cron = "0 0 * * * *") // 매 정시(*시 0분 0초)
	public void test() {
//		System.out.println("스케쥴러가 일정시간 마다 자동으로 출력");
		...
		// 1) 서버에 저장된 파일 목록 조회
		// -> application 객체를 이용해서 /resources/images/board 실제 서버 경로를 얻어옴
		String filePath = servletContext.getRealPath("/resources/images/board");
		// F:\workspace\06_Framework\boardProject\src\main\webapp\resources\images
...
//		for(String s : dbImageList) {System.out.println(s.toString());}
