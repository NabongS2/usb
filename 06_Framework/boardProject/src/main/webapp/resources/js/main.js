...
btn2.addEventListener("click",()=>{
    ...
    fetch("/selectMember",{
        method : "POST",
        headers : {"Content-Type":"application/json"}, // 보내주는 타입 명시
