...
public class BoardController2 {
	...
	@GetMapping("/{boardCode:[0-9]+}/insert") // 숫자로 된 한자리 이상
	...
	public String boardInsert(
		...
		/*	List<MultipartFile>
		 * 	- 업로드된 이미지가 없어도 List에 요소에 MultipartFile 객체가 추가됨
		 * 
		...
		// 게시글 삽입 성공 시 -> 방금 삽입한 게시글의 상세 조회 페이지 리다이렉트
