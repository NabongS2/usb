...
<body>
    ...
    <pre>
        JSP에서 자주 사용되거나 공통적으로 사용되는 JAVA 코드(if, for, 변수 선언, 형변환)
        스크립클릿 대신 HTML 태그 형식을 태그화하여 표준으로 제공하는 라이브러리
        (if, for 간단히 쓰고 싶으면 라이브러리 사용해라)
    </pre>
    ...
    <ol>
        <li>
            ...
            <br>
            standard-impl-1.2.5 -> Jar Files -> Impl, Spec, EL 다운로드
        </li>
    ...
    <c:set var="num2" value="20" scope="page"/> <%-- 열자마자 닫겠다 </> 중간 내용 X --%> 
    ...
    <%-- requestScope에 세팅 --%>
    <c:set var="num2" value="30" scope="request"/> <br>
