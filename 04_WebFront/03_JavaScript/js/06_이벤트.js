...
// const cal = document.getElementsByClassName("calculator");
// const plus = document.getElementById("plus");
// const minus = document.getElementById("minus");
// const multi = document.getElementById("multi");
// const div = docmultiument.getElementById("div");
// const mod = docmultiument.getElementById("mod");
...
// minus = document.getElementById("minus").addEventListener("click",function(e){
//     result.innerText=Number(num1.value)-Number(num2.value);
...
// form태그 기본 이벤트 제거 1
// -> submit 버튼을 없애고 일반 button이 클릭 되었을 때 조건이 맞으면 submit하게 만들기
...
function fnCheck(){
    ...
    if(id=='user01'&& pw=='pass01'){
        // 아이디, 비밀번호가 일치 할 때 form 태그 제출        
        return true; // true를 반환해서 제출 수행
    }
    return false; // true를 반환해서 제출 수행
