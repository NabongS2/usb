...
function acessClass(){
    ...
    for(var i=0; i<div2Arr.length; i++){
        div2Arr[i].style.backgroundColor = "rgb(100,200,"+(i*100)+")";
    }
}
...
function cssTest(){
    ...
    document.querySelector("#cssDiv>div").style.fontSize="24px";

    // querySelectorAll("선택자") : 모든 요소 선택(배열 반환)
...
function readValue(){
    ...
    if(input.value.trim().length>0){
        ...
        // 요소.scrollTop = 위치 : 스크롤 지정된 위치로 이동
