...
function clickCount(el){
    ...
    // el.innerText=Number(innerText)+1;
    el.innerText++;
    if(el.innerText>20){el.innerText = 0;}
...
// 화살표 함수 : (e) => {}
//             : e => {} // () 생략가능! 
//             3. 매개 변수가 2개 이상 또는 0개 이면 () 생략 불가능!
...
// 클릭된 요소의 테두리를 3px 실선 pink로 변경(화살표, e사용 x, this 사용 o)
button6.addEventListener("click",()=>{
    // 이벤트 핸들러로 지정된 익명 함수의 this == 이벤트가 발생한 요소
    console.log(this);
    // 화살표 함수에 this를 작성하면 이벤트가 발생한 요소가 아닌
    // 창 자체를 나타내는 window 객체가 반환 된다.
