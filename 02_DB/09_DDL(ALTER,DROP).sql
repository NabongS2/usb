...
ALTER TABLE DEPT_COPY DROP CONSTRAINT SYS_C007540; -- NOT NULL
--> NOT NULL 제약조건 ADD는 안되는데 DROP은 가능

-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY 
MODIFY DEPT_TITLE CONSTRAINT SYS_C007540 /*NOT*/ NULL;
--> 이 구문으로 NOT NULL 추가했다가 지웠다 가능하다.
...
SELECT * FROM DEPT_COPY; -- 기본 값 NULL
...
-- DEPT_COPY의 LAME 컬럼의 모든 값을 기본값으로 수정
UPDATE DEPT_COPY
